...
$sql = "SELECT address,bike_model FROM bike";
...
// Google API Key
$apiKey = "AIzaSyCzWK845lT1EQvUKg05tCUsvGojzUEqO7I";     //Expires in september 2nd 2024
...
foreach ($properties as $property) {
    ...
    if ($latLng) {
        $propertiesWithLatLng[] = array_merge($latLng, ['bike_model' => $property['bike_model']]);
    }
}
?>
...
<body>
    ...
    <div class="legend">
        <div><img src="http://maps.google.com/mapfiles/ms/icons/red-dot.png" alt="Property Icon"> Bikes</div>
    ...
    function initMap() {
        ...
        properties.forEach(function(property) {
            new google.maps.Marker({
                ...
                map: map,
                title: property.bike_model // Add title to the marker
            });
        });
    }
    document.getElementById('backButton').addEventListener('click', function() {
        window.location.href = '/Link2Serve/pages/all_bikes.php'; // Navigate to listings.php
    });
    </script>
</body>
</html>
