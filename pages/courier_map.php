...
$sql = "SELECT courier_address,courier_name FROM courier";
...
// Google API Key
$apiKey = "AIzaSyBEzqkWXa-fr9jizC5SMkhcJ-gPfhNHsoo";     //Expires in september 2nd 2024
...
foreach ($properties as $property) {
    $latLng = getLatLong($property['courier_address'], $apiKey);
    if ($latLng) {
        $propertiesWithLatLng[] = array_merge($latLng, ['courier_name' => $property['courier_name']]);
    }
}
?>
...
<html>
<head>
    <title>Couriers Map</title>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBEzqkWXa-fr9jizC5SMkhcJ-gPfhNHsoo&libraries=places"></script>
    <link rel="stylesheet" href="../css/map.css">
</head>
<body>
    
    <div class="legend">
        <div><img src="http://maps.google.com/mapfiles/ms/icons/red-dot.png" alt="Property Icon"> Courier Services</div>
    ...
    function initMap() {
        ...
        properties.forEach(function(property) {
            new google.maps.Marker({
                ...
                map: map,
                title: property.courier_name // Add title to the marker
            });
        });
    }
    document.getElementById('backButton').addEventListener('click', function() {
        window.location.href = '/Link2Serve/pages/all_couriers.php'; // Navigate to listings.php
    });
    </script>
</body>
</html>
