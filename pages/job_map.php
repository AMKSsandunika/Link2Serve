...
$sql = "SELECT address,title FROM job";
...
foreach ($properties as $property) {
    ...
    if ($latLng) {
        $propertiesWithLatLng[] = array_merge($latLng, ['title' => $property['title']]);
    }
}
?>
...
<body>
    ...
    <div class="legend">
        <div><img src="http://maps.google.com/mapfiles/ms/icons/red-dot.png" alt="Property Icon"> Jobs</div>
    ...
    function initMap() {
        ...
        properties.forEach(function(property) {
            new google.maps.Marker({
                ...
                map: map,
                title: property.title // Add title to the marker
            });
        });
    }

    document.getElementById('backButton').addEventListener('click', function() {
        window.location.href = '/Link2Serve/pages/alljobs.php'; // Navigate to listings.php
    });
    </script>
</body>
</html>
