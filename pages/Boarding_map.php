...
$sql = "SELECT address,property_name FROM property";
...
// Google API Key
$apiKey = "AIzaSyBEzqkWXa-fr9jizC5SMkhcJ-gPfhNHsoo";
...
foreach ($properties as $property) {
    ...
    if ($latLng) {
        $propertiesWithLatLng[] = array_merge($latLng, ['property_name' => $property['property_name']]);
    }
}
?>
...
<body>
    ...
    <div class="legend">
        <div><img src="http://maps.google.com/mapfiles/ms/icons/red-dot.png" alt="Property Icon"> Boarding Places</div>
    ...
    function initMap() {
        ...
        properties.forEach(function(property) {
            new google.maps.Marker({
                ...
                map: map,
                title: property.property_name // Add title to the marker
            });
        });
    }

    document.getElementById('backButton').addEventListener('click', function() {
        window.location.href = '../listings.php'; // Navigate to listings.php
    });
    </script>
</body>
</html>
